To run the project code simply use the run all feature of the Car Price Prediction.iypnb file.
...
You can find all files on Github: https://github.com/syl21b/Car-Price-Prediction.git
